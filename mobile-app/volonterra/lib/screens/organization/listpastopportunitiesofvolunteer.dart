...
import 'package:volonterra/screens/organization/opportunityscreen.dart';
import 'package:volonterra/styles.dart';
import 'package:volonterra/models/opportunity.dart';

class ListPastOpportunities extends StatefulWidget {
  final List<Opportunity> opportunities;
  final int volunteerId;

  ListPastOpportunities({Key key, @required this.opportunities,
    @required this.volunteerId}) : super(key: key);
  @override
  _ListPastOpportunitiesState createState() => _ListPastOpportunitiesState();
}


class _ListPastOpportunitiesState extends State<ListPastOpportunities> {

...
public class OpportunityDetailsForVolunteer {
	private Long id;
	private String name;
	...
	public OpportunityDetailsForVolunteer(Opportunity o, Volunteer v) {
		this.id = o.getId();
		this.name = o.getName();
		...
		this.hasApplied = v.getAppliedOpportunities().contains(o);
	}
